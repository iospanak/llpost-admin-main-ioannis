...
export const ZonesEditor = (counties: any[], carrier: string, onlyDelivery:boolean ) => {
	...
	const addPrice = (zone: any) => {
		console.log(zone)
		apiService.post('/carriers/'+carrier+'/set-price-zone', {
			name: zone.name,
	...
	const remove = (id: string) => {
		apiService.delete('/carriers/'+carrier+'/remove-price-zone/' + id).then(() => {
			getZones().then(null);
